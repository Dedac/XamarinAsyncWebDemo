...
extern void *mono_aot_module_AsyncWebCallNeverReturns_info;
...
{
	mono_aot_register_module (mono_aot_module_AsyncWebCallNeverReturns_info);
...
void monotouch_setup ()
{
	...
	monotouch_assembly_name = "AsyncWebCallNeverReturns.exe";
	mono_use_llvm = FALSE;
